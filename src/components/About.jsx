...
export default function About() {
  ...
  return (
    <section
      ref={sectionRef}
      className="section mx-auto max-w-6xl px-8 py-28"
    >
      <div className="grid gap-10 md:grid-cols-[220px_1fr] md:gap-16">
        <div className="select-none">
          <div
            ref={numberRef}
            className="font-display text-[8rem] font-extrabold leading-none opacity-15"
        ...
        <div ref={contentRef} className="section-item will-change-transform">
          <p
            ...
            style={{ color: 'var(--text-secondary)' }}
          >
            Sou desenvolvedor frontend focado em criar landing pages e interfaces
            para SaaS com visual moderno, boa performance e experiência clara.
            Uso IA para acelerar entregas sem abrir mão de qualidade, organização
            e manutenção.
          </p>
